...
- (void)startObserving
{
  ...
  if (self.bridge.launchOptions[UIApplicationLaunchOptionsRemoteNotificationKey]) {
    ...
    UILocalNotification *localNotification =
      [self.bridge.launchOptions[UIApplicationLaunchOptionsLocalNotificationKey] copy];
